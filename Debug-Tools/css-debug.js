// Vantagraph Debug - 3-layer color override inspector
// Paste into DevTools console OR load as extension.
// Output: Spotify (Encore) default -> Spicetify --spice-* -> Vantagraph inline override
...
(function VantagraphDebug() {
  ...
  // --- Layer 3: Vantagraph inline overrides (root.style.setProperty in applyTheme) ---
  const vgInlineMap = {};
  ...
  const themeName = (() => {
    try { return Spicetify.LocalStorage.get("vantagraph:theme") || "?"; } catch(e) { return "?"; }
  })();
  ...
  console.group("%c[C] All Vantagraph inline overrides on :root  (applyTheme output)", "color:#1ed760;font-weight:bold");
