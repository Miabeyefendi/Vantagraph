// Vantagraph LoopyLoop - right-click progress bar to set loop start/end
//
...
(function LoopyLoop() {
  ...
  if (window.VantagraphData?.applyDynamicClasses) {
    window.VantagraphData.applyDynamicClasses();
  }
